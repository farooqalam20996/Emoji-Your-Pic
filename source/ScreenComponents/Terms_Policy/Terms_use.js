...
var that;
 export default class Terms_use extends Component {
       ...
       PrivacyPolicyTxt = () => {
            ...
            var config = {
                method: 'get',
                url: API+'salvador_app/public/api/get-terms-and-conditions',
            };
            ...
            .then(function (response){
                if(response.data.success){
                    ...
                    that.setState({text: response.data.TermsAndConditions})
                }
            })
       ...
       Heading_Txt = <Text style={{color:"black"}} > Term's &amp; Conditions </Text>
        ...
        const Txt = '<div style="color: white">' + this.state.text + '</div>';
         ...
         return (
            <View style={styles.main} >
                <Top_Header Heading="Term's &amp; Use" btn={<Text style={styles.can_Txt} onPress={() => this.props.navigation.goBack()} >Back</Text>} />
                {
                    this.state.Failed ?
